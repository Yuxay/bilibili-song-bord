      ...
      if (this.mainTabs.length >= 1) {
        ...
        if (tabName === this.mainTabsActiveName) {
          if (
            ...
            this.$router.push(
              { name: "charge-site/site", query: undefined, params: undefined },
              () => {
                this.mainTabsActiveName = this.$route.name;
              }
            );
          } else if (tabName === "deviceInfo") {
            this.$router.push(
              { name: "charge-device/device", query: undefined, params: undefined },
              () => {
                this.mainTabsActiveName = this.$route.name;
              }
            );
          } else if (tabName === "orderInfo") {
            this.$router.push(
              { name: "charge-order", query: undefined, params: undefined },
              () => {
                this.mainTabsActiveName = this.$route.name;
              }
            );
