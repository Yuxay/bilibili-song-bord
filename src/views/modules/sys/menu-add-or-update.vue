  ...
  export default {
    ...
    methods: {
      init (id) {
        ...
        this.$http({
          url: this.$http.adornUrl('/pc/v1/menu/select'),
          method: 'get',
          ...
          if (!this.dataForm.id) {
            ...
            // 修改
            this.$http({
              url: this.$http.adornUrl(`/pc/v1/menu/info/${this.dataForm.id}`),
              method: 'get',
              params: this.$http.adornParams()
            }).then(({data}) => {
      ...
      dataFormSubmit () {
        ...
        this.$refs['dataForm'].validate((valid) => {
          if (valid) {
            this.$http({
              url: this.$http.adornUrl(`/pc/v1/menu/${!this.dataForm.id ? 'save' : 'update'}`),
              method: 'post',
